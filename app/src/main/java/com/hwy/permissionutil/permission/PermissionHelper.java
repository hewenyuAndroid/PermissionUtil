...
public class PermissionHelper {
    ...
    public static void showTipsDialog(Context context) {
        showTipsDialog(context, "警告!", "当前应用缺少必要权限，该功能暂时无法使用。如若需要，请单击【确定】按钮前往设置中心进行权限授权。");
    }

    /**
     * 显示提示对话框
     */
    public static void showTipsDialog(final Context context, String title, String msg) {
